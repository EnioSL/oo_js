...
class SmartWatch extends Dispositivo {
    constructor(sistOp, fabricante, memRam, armazInterno, anoFabricacao, modelo, tipoPulseira, batimentosMinuto) {
        super(sistOp, fabricante, memRam, armazInterno, anoFabricacao, modelo);
...
const smartwatch1 = new SmartWatch("Wear OS", "Google", 1, 8, 2024, "Pixel Watch", "Silicone", 72);
